...
// // 計算前一個月和下一個月的年份和月份
// $prev_month_year = date("Ym", strtotime("first day of previous month"));
// $prev_month = date("n", strtotime("first day of previous month"));
// $next_month_year = date("Ym", strtotime("first day of next month"));
// $next_month = date("n", strtotime("first day of next month"));
